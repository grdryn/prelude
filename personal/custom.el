(custom-set-variables
 ...
 '(package-selected-packages
   '(protobuf-mode vertico nix-mode helm-rg helm-lsp forge emacsql-sqlite poly-erb keycast lsp-metals fira-code-mode dhall-mode csv-mode pcap-mode transient scala-mode cython-mode lsp-python-ms lsp-java ron-mode lsp-ui company-lsp nlinum ag zop-to-char zenburn-theme yari which-key web-mode volatile-highlights undo-tree tide super-save smartrep smartparens scss-mode rainbow-mode rainbow-delimiters poly-ansible pinentry operate-on-number move-text json-mode js2-mode inf-ruby imenu-anywhere hl-todo helm-projectile helm-descbinds  haskell-mode guru-mode groovy-mode gotest golint go-snippets go-projectile gnu-elpa-keyring-update git-timemachine gist geiser flycheck-rust expand-region exec-path-from-shell elisp-slime-nav editorconfig easy-kill dockerfile-mode discover-my-major diminish diff-hl dap-mode crux counsel company-go company-ansible company-anaconda cargo browse-kill-ring beacon archive-rpm anzu ansible-vault adoc-mode))
